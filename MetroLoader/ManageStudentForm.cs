...
{
    public partial class ManageStudentForm : MetroForm
    {
        ...
        {
            metroTextBox5.Text = DataGridView_student.CurrentRow.Cells[0].Value.ToString();
            metroTextBox1.Text = DataGridView_student.CurrentRow.Cells[1].Value.ToString();
            metroTextBox3.Text = DataGridView_student.CurrentRow.Cells[2].Value.ToString();
            ...
            metroTextBox2.Text = DataGridView_student.CurrentRow.Cells[5].Value.ToString();
            metroTextBox4.Text = DataGridView_student.CurrentRow.Cells[6].Value.ToString();
        ...
        bool verify()
        {
            if ((metroTextBox1.Text == "") || (metroTextBox3.Text == "") ||
                (metroTextBox2.Text == "") || (metroTextBox4.Text == "") ||
                (pictureBox_student.Image == null))
            {
                return false;
            }
