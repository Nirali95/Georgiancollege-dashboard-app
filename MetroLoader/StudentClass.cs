...
namespace MetroLoader
{
    internal class StudentClass
    {
        ...
        public bool useradd(string uname, string pass)
        {
            MySqlCommand command = new MySqlCommand("INSERT INTO `user`(`username`, `password`) VALUES(@un, @pw)", connect.getconnection);
